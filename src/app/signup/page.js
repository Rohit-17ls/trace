    ...
    return(
        <div className="h-[100vh] w-[100vw] flex flex-row justify-center items-center">
            <div className="m-auto rounded-lg p-5 bg-cardbg card-shadow max-w-[550px] w-[35vw] min-w-[400px]">
                <strong className="text-2xl text-white block text-center my-[7vh]">Sign Up</strong>
                <form action = {handleSignUp} className="flex flex-col justify-evenly items-center gap-[60px]">
                ...
                <div className="mt-8 text-center text-defaultbg text-sm">Already have an account?
                <span className="link"><Link href='/signin'>Sign in</Link></span></div>
            </div>
        </div>
    )
}